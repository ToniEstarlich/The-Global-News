class SportComponent extends HTMLElement {
    connectedCallback() {
        ...
        <div class="news" id="sportsNews">
            <div class="title">
                <h2 class="news-title" style="text-decoration: underline; color: white; margin-left: 86px; margin-botton: 20px; font-size: 50px;">Sports</h2>
...
window.customElements.define('sport-component', SportComponent);
